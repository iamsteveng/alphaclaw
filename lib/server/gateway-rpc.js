...
// Offer a protocol range so a gateway version bump doesn't break RPC with a
// "protocol mismatch". The gateway accepts when its PROTOCOL_VERSION is within
// [min, max]. OpenClaw moved 3 -> 4 (2026.6.x) with identical connect framing.
