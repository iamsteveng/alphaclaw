const buildIngestMessage = (listId) =>
  `Fetch the 10 most recent posts from X list ID ${listId} using
  xurl "/2/lists/${listId}/tweets?tweet.fields=note_tweet,article&max_results=10"
(exact command — do not omit tweet.fields or the long-form body will be missing).
