...
const registerServerRoutes = ({
  ...
  registerXListIngestRoutes({ app, requireAuth, gatewayRpc: createGatewayRpc({ getGatewayToken }) });
  registerMarketRiskScoreRoutes({ app, requireAuth, gatewayRpc: createGatewayRpc({ getGatewayToken }) });
  registerTradingCronRoutes({ app, requireAuth, gatewayRpc: createGatewayRpc({ getGatewayToken }) });
