...
**Script location:** `skills/market-risk-score/market_risk_score.py` (relative to your workspace root)
...
**Classifications:** ✅ Risk On (0) · 🟡 Neutral (1) · ⚠️ Caution (2) · 🔴 Risk Off (3–4 bearish signals)

Weekend/holiday dates automatically roll back to the prior trading day. Data from Yahoo Finance public API — no auth required.
