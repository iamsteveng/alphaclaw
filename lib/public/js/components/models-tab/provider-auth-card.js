    ...
    <div class="space-y-2">
      ...
      ${claudeCodeStatus?.configured && !authStarted
        ...
        ? html`
            <div class="space-y-2">
              <p class="text-xs text-fg-muted">
                Authorize on Claude.ai. Your browser will redirect to http://localhost:44889/callback and show a connection error — that's expected. Copy the full URL from your address bar and paste it below.
              </p>
              <a
                href=${authUrl}
                target="_blank"
