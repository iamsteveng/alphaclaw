...
const CreateWebhookModal = ({
  ...
  return html`
    ...
    >
      <div
        class="bg-modal border border-border rounded-xl p-5 max-w-lg w-full space-y-4"
      >
        <${PageHeader}
          ...
          actions=${html`
            <button
              type="button"
              onclick=${onClose}
              class="h-8 text-xs px-2.5 rounded-lg ac-btn-secondary"
            >
              Close
            </button>
          `}
        ...
        <div class="pt-1 flex items-center justify-end gap-2">
          ...
          <button
            ...
            class="px-4 py-2 rounded-lg text-sm ac-btn-cyan ${!canCreate ||
            creating
    ...
    <div class="space-y-4">
      <${PageHeader}
        ...
        actions=${selectedHookName
          ...
          : html`
              <button
                class="text-xs px-3 py-1.5 rounded-lg border border-border text-gray-300 hover:text-gray-100 hover:border-gray-500"
            ...
            >
              <div class="flex items-start justify-between gap-3">
                ...
                <button
                  ...
                  disabled=${deleting}
                  class="text-xs px-2.5 py-1 rounded-lg border border-red-500/40 text-red-300 hover:text-red-200 hover:border-red-400 shrink-0 ${deleting
                    ? "opacity-50 cursor-not-allowed"
                    : ""}"
                >
